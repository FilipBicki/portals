...
execute if block ~ ~-1 ~1 minecraft:nether_bricks if block ~ ~-1 ~2 minecraft:nether_bricks if block ~ ~-1 ~-1 minecraft:nether_bricks if block ~ ~ ~-1 minecraft:nether_bricks if block ~ ~ ~2 minecraft:nether_bricks if block ~ ~1 ~-1 minecraft:nether_bricks if block ~ ~1 ~2 minecraft:nether_bricks if block ~ ~2 ~-1 minecraft:nether_bricks if block ~ ~2 ~2 minecraft:nether_bricks if block ~ ~3 ~-1 minecraft:nether_bricks if block ~ ~3 ~2 minecraft:nether_bricks if block ~ ~3 ~ minecraft:nether_bricks if block ~ ~3 ~1 minecraft:nether_bricks at @e[type=minecraft:item_frame,distance=0..1,tag=portal2_align] positioned ~ ~1 ~0.5 run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal2_z","portal2","cloud_active"]}

execute if block ~ ~-1 ~-1 minecraft:nether_bricks if block ~ ~-1 ~-2 minecraft:nether_bricks if block ~ ~-1 ~1 minecraft:nether_bricks if block ~ ~ ~1 minecraft:nether_bricks if block ~ ~ ~-2 minecraft:nether_bricks if block ~ ~1 ~1 minecraft:nether_bricks if block ~ ~1 ~-2 minecraft:nether_bricks if block ~ ~2 ~1 minecraft:nether_bricks if block ~ ~2 ~-2 minecraft:nether_bricks if block ~ ~3 ~1 minecraft:nether_bricks if block ~ ~3 ~-2 minecraft:nether_bricks if block ~ ~3 ~ minecraft:nether_bricks if block ~ ~3 ~-1 minecraft:nether_bricks at @e[type=minecraft:item_frame,distance=0..1,tag=portal2_align] positioned ~ ~1 ~-0.5 run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal2_z","portal2","cloud_active"]}

execute if block ~1 ~-1 ~ minecraft:nether_bricks if block ~2 ~-1 ~ minecraft:nether_bricks if block ~-1 ~-1 ~ minecraft:nether_bricks if block ~-1 ~ ~ minecraft:nether_bricks if block ~2 ~ ~ minecraft:nether_bricks if block ~-1 ~1 ~ minecraft:nether_bricks if block ~2 ~1 ~ minecraft:nether_bricks if block ~-1 ~2 ~ minecraft:nether_bricks if block ~2 ~2 ~ minecraft:nether_bricks if block ~-1 ~3 ~ minecraft:nether_bricks if block ~2 ~3 ~ minecraft:nether_bricks if block ~ ~3 ~ minecraft:nether_bricks if block ~1 ~3 ~ minecraft:nether_bricks at @e[type=minecraft:item_frame,distance=0..1,tag=portal2_align] positioned ~0.5 ~1 ~ run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal2_x","portal2","cloud_active"]}

execute if block ~-1 ~-1 ~ minecraft:nether_bricks if block ~-2 ~-1 ~ minecraft:nether_bricks if block ~1 ~-1 ~ minecraft:nether_bricks if block ~1 ~ ~ minecraft:nether_bricks if block ~-2 ~ ~ minecraft:nether_bricks if block ~1 ~1 ~ minecraft:nether_bricks if block ~-2 ~1 ~ minecraft:nether_bricks if block ~1 ~2 ~ minecraft:nether_bricks if block ~-2 ~2 ~ minecraft:nether_bricks if block ~1 ~3 ~ minecraft:nether_bricks if block ~-2 ~3 ~ minecraft:nether_bricks if block ~ ~3 ~ minecraft:nether_bricks if block ~-1 ~3 ~ minecraft:nether_bricks at @e[type=minecraft:item_frame,distance=0..1,tag=portal2_align] positioned ~-0.5 ~1 ~ run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal2_x","portal2","cloud_active"]}


# Tag cloud active means that the portal detection succeeded but the cloud is still detecting
# Execute as position of portal2 armorstand marker
...
# Rotate portal2 marker to face perpendicular to portal frame
