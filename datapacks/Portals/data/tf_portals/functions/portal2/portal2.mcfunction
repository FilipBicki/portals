...
# Ensure stability
execute if block ^-0.5 ^-2 ^ minecraft:nether_bricks if block ^-1.5 ^-2 ^ minecraft:nether_bricks if block ^0.5 ^-2 ^ minecraft:nether_bricks if block ^1.5 ^-2 ^ minecraft:nether_bricks if block ^1.5 ^-1 ^ minecraft:nether_bricks if block ^-1.5 ^-1 ^ minecraft:nether_bricks if block ^1.5 ^ ^ minecraft:nether_bricks if block ^-1.5 ^ ^ minecraft:nether_bricks if block ^1.5 ^1 ^ minecraft:nether_bricks if block ^-1.5 ^1 ^ minecraft:nether_bricks if block ^1.5 ^2 ^ minecraft:nether_bricks if block ^-1.5 ^2 ^ minecraft:nether_bricks if block ^0.5 ^2 ^ minecraft:nether_bricks if block ^-0.5 ^2 ^ minecraft:nether_bricks run tag @s add stable
