...
execute if block ~ ~-1 ~1 minecraft:quartz_block if block ~ ~-1 ~2 minecraft:quartz_block if block ~ ~-1 ~-1 minecraft:quartz_block if block ~ ~ ~-1 minecraft:quartz_block if block ~ ~ ~2 minecraft:quartz_block if block ~ ~1 ~-1 minecraft:quartz_block if block ~ ~1 ~2 minecraft:quartz_block if block ~ ~2 ~-1 minecraft:quartz_block if block ~ ~2 ~2 minecraft:quartz_block if block ~ ~3 ~-1 minecraft:quartz_block if block ~ ~3 ~2 minecraft:quartz_block if block ~ ~3 ~ minecraft:quartz_block if block ~ ~3 ~1 minecraft:quartz_block at @e[type=minecraft:item_frame,distance=0..1,tag=portal1_align] positioned ~ ~1 ~0.5 run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal1_z","portal1","cloud_active"]}

execute if block ~ ~-1 ~-1 minecraft:quartz_block if block ~ ~-1 ~-2 minecraft:quartz_block if block ~ ~-1 ~1 minecraft:quartz_block if block ~ ~ ~1 minecraft:quartz_block if block ~ ~ ~-2 minecraft:quartz_block if block ~ ~1 ~1 minecraft:quartz_block if block ~ ~1 ~-2 minecraft:quartz_block if block ~ ~2 ~1 minecraft:quartz_block if block ~ ~2 ~-2 minecraft:quartz_block if block ~ ~3 ~1 minecraft:quartz_block if block ~ ~3 ~-2 minecraft:quartz_block if block ~ ~3 ~ minecraft:quartz_block if block ~ ~3 ~-1 minecraft:quartz_block at @e[type=minecraft:item_frame,distance=0..1,tag=portal1_align] positioned ~ ~1 ~-0.5 run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal1_z","portal1","cloud_active"]}

execute if block ~1 ~-1 ~ minecraft:quartz_block if block ~2 ~-1 ~ minecraft:quartz_block if block ~-1 ~-1 ~ minecraft:quartz_block if block ~-1 ~ ~ minecraft:quartz_block if block ~2 ~ ~ minecraft:quartz_block if block ~-1 ~1 ~ minecraft:quartz_block if block ~2 ~1 ~ minecraft:quartz_block if block ~-1 ~2 ~ minecraft:quartz_block if block ~2 ~2 ~ minecraft:quartz_block if block ~-1 ~3 ~ minecraft:quartz_block if block ~2 ~3 ~ minecraft:quartz_block if block ~ ~3 ~ minecraft:quartz_block if block ~1 ~3 ~ minecraft:quartz_block at @e[type=minecraft:item_frame,distance=0..1,tag=portal1_align] positioned ~0.5 ~1 ~ run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:nether_brick",Count:1b,tag:{CustomModelData:919190}}],Small:1b,NoGravity:1b,Invulnerable:1b,Tags:["portal1_x","portal1","cloud_active"]}
